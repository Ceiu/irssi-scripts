# based on irssi mouse script at http://wouter.coekaerts.be/site/irssi/mouse,
# which is based on irssi mouse patch by mirage: http://darksun.com.pt/mirage/irssi/
...
$VERSION = '1.0.0';
%IRSSI = (
	authors  	=> 'Wouter Coekarts, Chris Rog',
	contact  	=> 'crog@redhat.com',
	name    	=> 'mouse',
	description 	=> 'control irssi using mouse',
	license 	=> 'GPLv2 or later',
	url     	=> 'http://cericlabs.com',
	changed  	=> '2015-06-26',
);
...
sub mouse_event {
	...
	# We don't care about any other commands (currently)
}
...
# Command to enable/disable mouse handling.
Irssi::command_bind 'mouse disable' => sub {
	mouse_disable();
};

Irssi::command_bind 'mouse enable' => sub {
	mouse_enable();
};
...
settings_add_str("lookandfeel", "mouse_scroll_up", "/scrollback goto -1");
settings_add_str("lookandfeel", "mouse_scroll_down", "/scrollback goto +1");
